...
| :---- | ------------- | ----------- | -------------------------- |
| ISO   | [Link](https://get.mirantis.com/bootc-mke3/images/bootc-mke3-r9-bare-mcr29.2-mke3.9-simple.iso)      | **Simple** ISO with basic kickstart embedded. Unattended Anaconda installation will be performed. See [this document](docs/iso-editions.md#simple) to get more details about Simple image edition. | MCR 29.2.1 / MKE 3.9.0 |
| ISO   | [Link](https://get.mirantis.com/bootc-mke3/images/bootc-mke3-r9-bare-mcr29.2-mke3.9-generic.iso)      | **Generic** ISO without any customisation. See [this document](docs/iso-editions.md#generic-image-customisation.md) to get the details on how to properly customise it | MCR 29.2.1 / MKE 3.9.0 |
| QCOW2 | [Link](https://get.mirantis.com/bootc-mke3/images/bootc-mke3-r9-cloud-mcr29.2-mke3.9.qcow2)      | Standard QEMU/KVM bootable image | MCR 29.2.1 / MKE 3.9.0 |
